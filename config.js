...
if (!(process.env.SESSION || process.env.SESSION_ID)) throw new Error("Raganork~f66551b3a3ab9a09d89f8184a657a95f:63396c34466c305a572b4d3d")
module.exports = {
    VERSION: 'v4.0.0',
    ...
    ANTI_SPAM: process.env.ANTI_SPAM || '923228033682-923127655369@g.us',
    ...
    DISABLED_COMMANDS: (process.env.DISABLED_COMMANDS ? process.env.DISABLED_COMMANDS.split("true") : undefined) || [],
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || 'Raganork~f66551b3a3ab9a09d89f8184a657a95f:63396c34466c305a572b4d3d').trim() || '',
    ...
    RBG_KEY: process.env.RBG_KEY || '1234',
    ALLOWED: process.env.ALLOWED || '91,94,92',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'on',
    HANDLERS: process.env.HANDLERS || 'false',
    STICKER_DATA: process.env.STICKER_DATA || "ASIM🇵🇰",
    BOT_NAME: process.env.BOT_NAME || 'ASIM 😎',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'ꪶ͢٭𝑺𝜣𝑼𝑹𝛢𝑽𝑲𝑳¹¹ꫂ;ASIM MD bot;https://i.imgur.com/P7ziVhr.jpeg' : process.env.AUDIO_DATA,
    ...
    SUDO: process.env.SUDO || "923127655369",
